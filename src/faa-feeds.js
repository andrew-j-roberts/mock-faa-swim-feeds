...
function createMockFdpsPositionTick() {
  ...
  let randomAircraftIdentifierPrefix = aircraftIdentifierPrefixes[Math.floor(Math.random() * identifierPrefixes.length - 1)];
  let randomAircraftIdentifierNumber = createRandomIntBetween(1000, 9000);
